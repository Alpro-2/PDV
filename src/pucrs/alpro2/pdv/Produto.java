...
public class Produto {
	...
	public Produto(final String ian, final String descricao,
		...
		if (valorEmCentavos <= 0)
			throw new PdvException("O valor deve ser maior do que zero!");

		checkIsNull(ian, "IAN não pode ser nulo!");
		checkIsNull(descricao, "Descricao não pode ser nulo!");
		checkIsNull(unidade, "Unidade não pode ser nulo!");
	...
	private static void checkIsNull(String valor, String msg) throws PdvException {
		if (valor == null)
			throw new PdvException(msg);
	}
